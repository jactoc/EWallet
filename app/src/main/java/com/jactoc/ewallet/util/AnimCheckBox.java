...
/**
 * Created by jacopo on 2016-01-04.
 */
...
public class AnimCheckBox extends View {
    ...
    private void initDrawHookPaint(){
        mPaint.setAlpha(0xFF);    // default 0xFF
        mPaint.setStyle(Paint.Style.STROKE);
        mPaint.setStrokeWidth(mStrokeWidth);
        mPaint.setColor(mStrokeColor);
    }
    ...
    private void initDrawAlphaStrokeCirclePaint(){
        ...
        mPaint.setStyle(Paint.Style.STROKE);
        mPaint.setColor(mStrokeColor);
        mPaint.setAlpha(0x40);      // default 0x40
    }
    ...
    public void setChecked(boolean checked, boolean animation){
        ...
        if (animation){
            ...
            //sweep angle inverted i have the empty circle light blue and checked in primary blue
            if (mChecked){
    ...
    /** listener disabled in the constructor **/
